...
spongebob_squarepants:
  ...
  email       : "spongebobsquarepants@futurebuddies.com"
...
To assign Spongebob Squarepants as an author for our post. We'd add the following YAML front matter to a post:

```yaml
author: spongebob_squarepants
```
